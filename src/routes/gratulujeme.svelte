...
<section class="relative mx-auto py-6 sm:py-10 px-6 max-w-6xl text-blue-web">
  <div class="">
    <div class="text-4xl text-center">🎉 Gratulujeme k nákupu vstupenek!</div>
    ...
    <div class="flex mt-6"><img class="m-auto max-w-3xl" src="/gifs/funny-celebrate-{Math.round((Math.random() * (9 - 1) + 1))}.gif" /></div>
